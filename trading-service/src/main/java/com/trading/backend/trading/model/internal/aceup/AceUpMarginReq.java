...
@ApiModel(value = "aceup-杠杠订单请求")
public class AceUpMarginReq extends PageTimeRangeExtReq {
    ...
    @ApiModelProperty(name = "symbol_list", value = "币对", example = "[\"BTC_USD\",\"ETH_USD\"]")
    ...
    @ApiModelProperty(name = "type_list", value = "订单类型:LIMIT,MARKET,STOP_LIMIT,STOP_MARKET", allowableValues = "LIMIT,MARKET,STOP_LIMIT,STOP_MARKET",
            example = "[\"LIMIT\", \"STOP_LIMIT\"]")
    private List<String> typeList;

    @ApiModelProperty(name = "strategy_list", example = "[\"FOK\",\"IOC\"]", value = "订单策略:FOK,IOC,GTC")
