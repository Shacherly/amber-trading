 ...
 */
@ApiModel(value = "现货修改记录")
@Data
@JsonNaming(PropertyNamingStrategy.SnakeCaseStrategy.class)
public class SpotModificationVo {
    ...
    @ApiModelProperty(name = "current_status", value = "订单状态 PRE_TRIGGER 待触发, EXECUTING 挂单中, EXCEPTION 异常, CANCELED 已取消, PART_CANCELED " +
			"部分成交取消, COMPLETED 完全成交",
